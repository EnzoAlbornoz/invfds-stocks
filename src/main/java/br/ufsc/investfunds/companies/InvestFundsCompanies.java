...
public class InvestFundsCompanies {
    ...
    public static void connectDatabase(String dbUrl, String dbName, String dbUser, String dbPassword) throws URISyntaxException {
        ...
        dataStore = new EntityDataStore<>(dataSource, Models.DEFAULT);
        // Store Data Source
    ...
    public static void runProcedure(BiConsumer<EntityDataStore<Persistable>, Path> procedure, Path filePath) {
        // Execute Procedure
